...
function startup()
  ...
  musicChannel:enqueue(musicFilename, 3)
  connect(g_game, { onGameStart = function() g_sounds.stopAll() end })
  connect(g_game, { onGameEnd = function() 
    modules.game_interface.getMapPanel():setMapShader(g_shaders.getDefaultMapShader())
      g_sounds.stopAll()
      musicChannel:enqueue(musicFilename, 3)
  end })
...
function init()
  ...
  g_window.setTitle("Avatar Online")
