...
function ProtocolLogin:sendLoginPacket()
  ...
  msg:addU16(g_game.getUpdateVersion())
...
function ProtocolLogin:parseCharacterList(msg)
  ...
  if g_game.getClientVersion() > 1010 then
    ...
    for i=1,charactersCount do
      ...
      if character.name ~= "Account Manager" then
        character.outfit = {
          type = msg:getU16();
          body = msg:getU8();
          feet = msg:getU8();
        ...
        --print(character.outfit)
        
        character.vocation = msg:getU8()
        character.level = msg:getU16()
        character.health = msg:getU16()
        character.healthmax = msg:getU16()
        character.mana = msg:getU16()
        character.manamax = msg:getU16()
      end
