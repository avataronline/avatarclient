...
DisabledCategory = {
  [MarketCategory.Runes] = true,
  [MarketCategory.Shields] = true,
...
MarketOfferStateString = {
  ...
  [MarketOfferState.Accepted] = "Accepted";
  [MarketOfferState.AcceptedEx] = "Accepted";
}

function getStateString( state )
  return MarketOfferStateString[state] or ""
end 
